...
export const metadata = {
    ...
    description: "Ask Ralph before you buy a car. Get budget fit, price guidance, visible risk notes, damage signals, mileage context and expert review when it matters.",
    openGraph: {
        title: "Found a car online? Ask Ralph before you buy.",
        description: "Ralph checks the price, damage, mileage, history and your budget before you commit.",
        type: "website"
    },
    twitter: {
...
export default function RootLayout({ children }: RootLayoutProps) {
    ...
    return (<html lang="en-GB" suppressHydrationWarning data-scroll-behavior="smooth">
