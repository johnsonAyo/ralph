export const landingLabels = {
  ...
  form: {
    ...
    budgetLabel: "Your full budget",
    budgetHint: "The most you want to spend in total, including known costs.",
...
export const profileLabels = {
  magicLinkCopy: "Send a sign-in link to your email to access Ask Ralph on another device.",
