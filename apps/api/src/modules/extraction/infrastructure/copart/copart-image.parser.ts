...
export async function fetchCopartLotImages(page: Page, cachedLotDetails?: JsonRecord): Promise<ExtractedImage[]> {
    ...
    const response = await page.evaluate(async ({ lotNumber: evaluatedLotNumber, countryCode: evaluatedCountryCode, marker }) => {
