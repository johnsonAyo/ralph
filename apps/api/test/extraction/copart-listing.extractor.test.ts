...
import { normalizeCopartImagesResponse, } from "@/modules/extraction/infrastructure/copart/copart-image.parser";
...
test("Copart extraction strategy builds a complete snapshot from cached JSON and image payload", () => {
  ...
  `;
    ...
    const snapshot = buildCopartListingSnapshot({
        listingUrl: "https://www.copart.co.uk/lot/49254916/clean-title-2014-vauxhall-astra-2-0-cdti-16v-sri-5dr-auto-newbury",
